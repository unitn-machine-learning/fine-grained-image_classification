...
if set == 'CUB':
    ...
    if set == 'CAR':
        ...
        model_path = './model_2/checkpoint/aircraft'      # pth save path
        root = './model_2/datasets/FGVC-aircraft'  # dataset path
        num_classes = 100
...
#    coordinates = indices2coordinates(indices_ndarrays, stride, input_size, ratios[i])
